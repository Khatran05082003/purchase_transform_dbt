...
,stg_dim_product__rename__cast_type AS (
  SELECT
  ...
  ,stg_dim_product_add_undefined_record AS (
  SELECT 
    product_key,
    product_name,
    product_number,
    ...
    standard_cost,
    list_price
  FROM stg_dim_product__rename__cast_type
...
SELECT
  *
FROM stg_dim_product_add_undefined_record
